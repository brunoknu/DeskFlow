        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResolutionSummary = table.Column<string>(type: "nvarchar(max)", maxLength: 5000, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketAssignmentHistories_ChangedAtUtc",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketAttachments_FileHash",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketComments_TicketId_IsInternal",
                table: "TicketComments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_FirstResponseDueAtUtc",
                table: "Tickets",
                column: "FirstResponseDueAtUtc");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_ResolutionDueAtUtc",
                table: "Tickets",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_Status_AssignedAgentId",
                table: "Tickets",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_Status_ResolutionDueAtUtc",
                table: "Tickets",
                columns: new[] { "Status", "ResolutionDueAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_TicketStatusHistories_ChangedAtUtc",
